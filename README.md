...
- [Parceler](https://github.com/johncarl81/parceler) - Parcelables through code generation
- [DBFlow](https://github.com/Raizlabs/DBFlow) - ORM library
- [Gson](https://github.com/google/gson) - Serialization/deserialization library
- [ScalableVideoView](https://github.com/yqritc/Android-ScalableVideoView) -  Texture VideoView with Scale Types
- [Fenster](https://github.com/malmstein/fenster) - TextureView using a custom MediaPlayer controller

## License

    Copyright [2016] [Amit Goenka]
